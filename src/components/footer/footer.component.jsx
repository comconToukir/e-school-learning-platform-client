...
const Footer = () => {
  return (
    <div className="bg-base-300 mt-12 shadow-sm">
      ...
      <footer className="footer px-10 py-4 border-t text-base-content border-base-300 max-w-screen-xl mx-auto">
        <div className="items-center grid-flow-col">
          <img className="h-10 rounded-sm" src={Logo} alt="" />
          <p>
            E-School Online Ltd. <br />
            Providing reliable service 1792
          </p>
        </div>
